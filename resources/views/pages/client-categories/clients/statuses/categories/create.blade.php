<div class="modal fade" id="createModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('client-categories.status-categories.index', $clientCategory->id) }}">
                @csrf

                <div class="modal-header">
                    <h5 class="modal-title">Добавить категорию статуса</h5>
...
@if ($errors->any() && !old('_client_status_category_id'))
    <script>
